...
//                        }
        ...
        mContentView.findViewById(R.id.btn_create_group).setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
...
//        mContentView.findViewById(R.id.btn_create_group).setVisibility(View.VISIBLE);
